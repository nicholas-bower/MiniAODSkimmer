...
if runSignal:
    readFiles.extend([
       ...
       'root://cmsxrootd.fnal.gov//store/mc/RunIISummer20UL16MiniAODAPVv2/QCD_Pt_80to120_TuneCP5_13TeV_pythia8/MINIAODSIM/106X_mcRun2_asymptotic_preVFP_v11-v1/280000/955014FD-11F2-B943-91D1-B748BB2CB2AB.root'
    ])
else:
    readFiles.extend([
        #'file:patMiniAOD_standard.root'
