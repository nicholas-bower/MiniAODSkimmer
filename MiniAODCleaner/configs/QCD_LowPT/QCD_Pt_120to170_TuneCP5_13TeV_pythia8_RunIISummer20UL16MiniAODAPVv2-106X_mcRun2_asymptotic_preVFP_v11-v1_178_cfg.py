...
if runSignal:
    readFiles.extend([
       ...
       'root://cmsxrootd.fnal.gov//store/mc/RunIISummer20UL16MiniAODAPVv2/QCD_Pt_120to170_TuneCP5_13TeV_pythia8/MINIAODSIM/106X_mcRun2_asymptotic_preVFP_v11-v1/140000/02285CF9-7DAB-BD4F-80D5-D61EFEA571C6.root'
    ])
else:
    readFiles.extend([
        #'file:patMiniAOD_standard.root'
