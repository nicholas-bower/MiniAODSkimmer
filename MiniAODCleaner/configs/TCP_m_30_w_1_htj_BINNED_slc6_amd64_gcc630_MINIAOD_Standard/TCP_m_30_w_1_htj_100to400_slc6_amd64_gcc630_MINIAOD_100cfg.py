...
if runSignal:
    readFiles.extend([
       ...
       'root://cmseos.fnal.gov//store/user/nbower/Events/TCP_m_30_w_1_htj_100to400_slc6_amd64_gcc630_MINIAOD/TCP_m_30_w_1_htj_100to400_slc6_amd64_gcc630_MINIAOD_100.root'
    ])
else:
    readFiles.extend([
        #'file:patMiniAOD_standard.root'
...
if runSignal:
    process.output.fileName = 'root://cmseos.fnal.gov//store/user/nbower/Events/TCP_m_30_w_1_htj_BINNED_slc6_amd64_gcc630_MINIAOD_Skimmed_Standard/100to400//TCP_m_30_w_1_htj_100to400_slc6_amd64_gcc630_MINIAOD_100_SKIMMEDLowPT.root'
    if reclusterJets:
        process.output.fileName = 'root://cmseos.fnal.gov//store/user/nbower/Events/TCP_m_30_w_1_htj_BINNED_slc6_amd64_gcc630_MINIAOD_Skimmed_Standard/100to400//TCP_m_30_w_1_htj_100to400_slc6_amd64_gcc630_MINIAOD_100_SKIMMEDLowPT.root'
else:
    process.output.fileName = 'root://cmseos.fnal.gov//store/user/nbower/Events/TCP_m_30_w_1_htj_BINNED_slc6_amd64_gcc630_MINIAOD_Skimmed_Standard/100to400//TCP_m_30_w_1_htj_100to400_slc6_amd64_gcc630_MINIAOD_100_SKIMMEDLowPT.root'
