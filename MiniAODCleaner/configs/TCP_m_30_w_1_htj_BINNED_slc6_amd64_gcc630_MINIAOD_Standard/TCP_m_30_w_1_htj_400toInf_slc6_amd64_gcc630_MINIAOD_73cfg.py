...
if runSignal:
    readFiles.extend([
       ...
       'root://cmseos.fnal.gov//store/user/nbower/Events/TCP_m_30_w_1_htj_400toInf_slc6_amd64_gcc630_MINIAOD/TCP_m_30_w_1_htj_400toInf_slc6_amd64_gcc630_MINIAOD_73.root'
    ])
else:
    readFiles.extend([
        #'file:patMiniAOD_standard.root'
...
if runSignal:
    process.output.fileName = 'root://cmseos.fnal.gov//store/user/nbower/Events/TCP_m_30_w_1_htj_BINNED_slc6_amd64_gcc630_MINIAOD_Skimmed_Standard/400toInf//TCP_m_30_w_1_htj_400toInf_slc6_amd64_gcc630_MINIAOD_73_SKIMMEDLowPT.root'
    if reclusterJets:
        process.output.fileName = 'root://cmseos.fnal.gov//store/user/nbower/Events/TCP_m_30_w_1_htj_BINNED_slc6_amd64_gcc630_MINIAOD_Skimmed_Standard/400toInf//TCP_m_30_w_1_htj_400toInf_slc6_amd64_gcc630_MINIAOD_73_SKIMMEDLowPT.root'
else:
    process.output.fileName = 'root://cmseos.fnal.gov//store/user/nbower/Events/TCP_m_30_w_1_htj_BINNED_slc6_amd64_gcc630_MINIAOD_Skimmed_Standard/400toInf//TCP_m_30_w_1_htj_400toInf_slc6_amd64_gcc630_MINIAOD_73_SKIMMEDLowPT.root'
