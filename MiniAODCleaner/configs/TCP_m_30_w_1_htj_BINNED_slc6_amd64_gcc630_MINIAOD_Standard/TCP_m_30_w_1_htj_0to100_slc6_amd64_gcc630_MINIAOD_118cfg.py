...
if runSignal:
    readFiles.extend([
       ...
       'root://cmseos.fnal.gov//store/user/nbower/Events/TCP_m_30_w_1_htj_0to100_slc6_amd64_gcc630_MINIAOD/TCP_m_30_w_1_htj_0to100_slc6_amd64_gcc630_MINIAOD_118.root'
    ])
else:
    readFiles.extend([
        #'file:patMiniAOD_standard.root'
...
if runSignal:
    process.output.fileName = 'root://cmseos.fnal.gov//store/user/nbower/Events/TCP_m_30_w_1_htj_BINNED_slc6_amd64_gcc630_MINIAOD_Skimmed_Standard/0to100//TCP_m_30_w_1_htj_0to100_slc6_amd64_gcc630_MINIAOD_118_SKIMMEDLowPT.root'
    if reclusterJets:
        process.output.fileName = 'root://cmseos.fnal.gov//store/user/nbower/Events/TCP_m_30_w_1_htj_BINNED_slc6_amd64_gcc630_MINIAOD_Skimmed_Standard/0to100//TCP_m_30_w_1_htj_0to100_slc6_amd64_gcc630_MINIAOD_118_SKIMMEDLowPT.root'
else:
    process.output.fileName = 'root://cmseos.fnal.gov//store/user/nbower/Events/TCP_m_30_w_1_htj_BINNED_slc6_amd64_gcc630_MINIAOD_Skimmed_Standard/0to100//TCP_m_30_w_1_htj_0to100_slc6_amd64_gcc630_MINIAOD_118_SKIMMEDLowPT.root'
